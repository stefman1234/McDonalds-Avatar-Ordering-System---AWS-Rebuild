  ...
  await seedCategory("Drinks", 6, [
    {
      ...
      price: 4.00,
      aliases: ["small coke", "small coca cola", "coke small", "coke zero small", "diet coke small"],
    ...
    },
    {
      ...
      description: "Ice-cold classic Coca-Cola",
      price: 4.50,
      aliases: ["coke", "coca cola", "medium coke", "coke medium", "coke zero", "coke 0", "diet coke", "coca cola zero", "zero coke"],
      customizations: drinkCustomizations,
    },
    {
      ...
      description: "Ice-cold classic Coca-Cola",
      price: 5.00,
      aliases: ["large coke", "large coca cola", "coke large", "big coke", "large coke zero", "large diet coke", "coke zero large"],
      customizations: drinkCustomizations,
    },
    {
      name: "Sprite Small",
